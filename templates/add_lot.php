...
<form class="form form--add-lot container <?php if (!empty($errors)): echo 'form--invalid'; endif; ?>" action="add.php"
    ...
    <div class="form__container-two">
        <div class="form__item <?php echo errorClass($errors, 'lot-name'); ?>">
            ...
            <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота"
                   value="<?php echo strip_tags(getPostVal('lot-name')); ?>">
        ...
        <div class="form__item <?php echo errorClass($errors, 'category'); ?>">
            ...
            <select id="category" name="category">
                ...
                <?php foreach ($categories as $value): ?>
                    <option value="<?php echo strip_tags($value['id']) ?? ''; ?>" <?php if ($value['id'] === getPostVal('category')): echo 'selected'; endif; ?>><?php echo strip_tags($value['name']) ?? ''; ?></option>
                <?php endforeach; ?>
            </select>
    ...
    <div class="form__item form__item--wide <?php echo errorClass($errors, 'message'); ?>">
        ...
        <textarea id="message" name="message"
                  placeholder="Напишите описание лота"><?php echo strip_tags(getPostVal('message')); ?></textarea>
    ...
    <div class="form__item form__item--file <?php echo errorClass($errors, 'image'); ?>">
        ...
        <div class="form__input-file">
            <input class="visually-hidden" type="file" name="image" id="lot-img" value="<?php echo strip_tags(getPostVal('path')); ?>">
            <label for="lot-img">
                Добавить
            </label>
    ...
    <div class="form__container-three">
        <div class="form__item form__item--small <?php echo errorClass($errors, 'lot-rate'); ?>">
            ...
            <input id="lot-rate" type="text" name="lot-rate" placeholder="0" value="<?php echo strip_tags(getPostVal('lot-rate')); ?>">
        ...
        <div class="form__item form__item--small <?php echo errorClass($errors, 'lot-step'); ?>">
            ...
            <input id="lot-step" type="text" name="lot-step" placeholder="0" value="<?php echo strip_tags(getPostVal('lot-step')); ?>">
        ...
        <div class="form__item <?php echo errorClass($errors, 'lot-date'); ?>">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="lot-date"
                   placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?php echo strip_tags(getPostVal('lot-date')); ?>">
