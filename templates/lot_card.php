        ...
        <div class="lot-item__right">
            <div class="lot-item__state">
                ...
                <?php if (isset($_SESSION['name'])): ?>
                    <form class="lot-item__form" action="<?php echo 'lot.php?lot_id=' . $_GET['lot_id']; ?>" method="post" autocomplete="off">
                        <p class="lot-item__form-item form__item <?=errorClass($errors, 'cost');?>">
                            <label for="cost">Ваша ставка</label>
                            <input id="cost" type="text" name="cost" placeholder="<?=substr_replace(priceFormat($minBid), '', -3);?>" value="<?=getPostVal('cost');?>">
